        ...
        <div className={styles.inner}>
          <div className={styles.top_box}>
            ...
            <div className={styles.intro_box}>
              <p className={styles.intro_tit}>디자인과 기능 사이를 잇는, <br className={styles.mobile} /><FaQuoteLeft className={styles.icon} /> {title.split('').map((t, idx) => (<span key={idx} style={{animationDelay: `${idx * 0.04}s`}} className={styles.slice_text}>{t}</span>))} <FaQuoteRight className={styles.icon} /> 입니다.</p>
